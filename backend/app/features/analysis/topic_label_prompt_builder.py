    ...
    def build_prompt(
        ...
        *,
        ...
        return (
            ...
            "- If the tightest responses point to several different user needs and no single theme is shared by most responses, label it exactly 'Mixed Responses'.\n"
            "- Do not force a specific label from weak keyword overlap; use 'Mixed Responses' for incoherent or catch-all clusters.\n"
