    ...
    def build_prompt(
        ...
        *,
        ...
        return (
            ...
            "- top_unigrams, top_bigrams, and top_trigrams show recurring vocabulary with count and document_count; "
            "use document_count as the stronger frequency signal.\n"
            "- frequent_phrases is legacy phrase evidence; use it only to confirm the dominant topic or spot qualifiers like 'too expensive'.\n"
