    ...
    def build_prompt(
        ...
        *,
        ...
        return (
            ...
            "For each group, read the top terms and top comments, then identify "
            "the single aggregate topic shared across most of those responses. Return one specific, descriptive label per group_id.\n\n"
            "Rules:\n"
            ...
            "- terms are the strongest word signals for the cluster.\n"
            "- top_comments are the most central responses in the cluster; base the label on what most of them share.\n"
