...
from app.features.ingestion.cleaning_services._patterns import (
    MULTIPART_VERBATIM_SUFFIX_PATTERNS,
    NUMERIC_HEADER_PREFIX_PATTERN,
    TRANSFORMED_COLUMN_INDEX_SUFFIX_PATTERN,
)
from app.features.ingestion.cleaning_services.text_normalization_service import TextNormalizationService
