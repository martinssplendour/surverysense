...
class GeminiManifestDiagnosisService:
    ...
    def build_prompt(
        ...
        return (
            ...
            "- Always preserve stable identifier columns in metadata_indices when present, such as "
            "user/customer/respondent/participant IDs, names, emails, contacts, schools, or organisations.\n"
