...
class IngestAnalysisExportIntegrationTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.patchers = [
            ...
            patch("app.features.ingestion.routes.require_authenticated_user", return_value=fake_user),
            patch("app.features.analysis.routes.require_authenticated_user", return_value=fake_user),
            patch("app.features.results.routes.require_authenticated_user", return_value=fake_user),
        ]
