...
class AnalysisReportExportServiceTests(TestCase):
    ...
    def test_export_report_builds_pdf_document(self) -> None:
        ...
        self.assertEqual(artifact.filename, "sample-community-detection-report.pdf")
    ...
    def test_export_report_builds_docx_document_with_expected_sections(self) -> None:
        ...
        with ZipFile(BytesIO(artifact.content)) as archive:
            ...
            self.assertIn("Community summaries", document_xml)
    ...
    def test_export_report_builds_pptx_document_with_expected_sections(self) -> None:
        ...
        with ZipFile(BytesIO(artifact.content)) as archive:
            ...
            self.assertIn("Community summaries", slide_xml)
    ...
    def test_build_summary_heading_uses_community_wording_for_group_exports(self) -> None:
        self.assertEqual(self.service._build_summary_heading(self.request), "Community summaries")
